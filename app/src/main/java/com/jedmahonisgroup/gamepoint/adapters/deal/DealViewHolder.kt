...
class DealViewHolder(inflater: LayoutInflater, private val parent: ViewGroup, private val schoolColor: String?) :
        androidx.recyclerview.widget.RecyclerView.ViewHolder(inflater.inflate(R.layout.item_deal_list_2, parent, false)) {
    private var TAG: String = DealViewHolder::class.java.simpleName
