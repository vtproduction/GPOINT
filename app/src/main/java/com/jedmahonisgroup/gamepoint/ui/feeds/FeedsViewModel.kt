...
class FeedsViewModel(private val feedsDao: FeedsDao) : BaseViewModel() {
    //
    private var TAG: String = FeedsViewModel::class.java.simpleName
    ...
    var SponsorsFromServer: MutableLiveData<ArrayList<SponsorModel>> = MutableLiveData()
